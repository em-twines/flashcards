...
export default function Sidebar({collections, setCollections, center, setCenter}) {
  ...
  return (
          ...
          <div className = 'sidebar'>
            ...
            <div className = "collection-item" onClick= {()=>{setCollection(collections[0]) ; setCenter(true)}}><h4 >Flutter</h4></div>
            <div className = "collection-item" onClick=  {()=>{setCollection(collections[1]) ; setCenter(true)}}><h4 >CSS</h4></div>
            <div className = "collection-item" onClick= {()=>{setCollection(collections[2]) ; setCenter(true)}}><h4 >PANDAS</h4></div> 
          </div>
