...
export default function Collection({setCollection, collection, index, setIndex, cards, setCards, questions, setQuestions, modalShow, setModalShow, card, setCard, getCollection
}) {
  ...
  return (
        ...
        <DeleteCard collection = {collection} cards = {cards} index = {index} />
